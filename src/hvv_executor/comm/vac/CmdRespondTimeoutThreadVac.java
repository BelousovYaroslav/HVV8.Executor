    ...
    */
    ...
    public void run() {
        ...
        try {
            ...
            if( m_SocketRxTx.pCommandInAction != null) {
                logger.warn( "Вызываем обработку TimeOut'а!");
                if( m_SocketRxTx.pCommandInAction != null) {
                    if( m_SocketRxTx.pCommandInAction.GetProcessor() != null) {
                        m_SocketRxTx.pCommandInAction.GetProcessor().processTimeOut();
                    }
                    else {
                        logger.warn( "m_SocketRxTx.pCommandInAction = null! Обработки таймаута не будет.");
                    }
                }
                else {
                    logger.warn( "m_SocketRxTx = null! Обработки таймаута не будет.");
                }
                m_SocketRxTx.pCommandInAction = null;
            }
            else {
